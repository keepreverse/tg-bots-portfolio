...
Lifted from `booking-bot/render.py` — same single-main-message pattern.
...
* `PHONE_AUX_MSG_KEY` tracks the small auxiliary message that hosts the
  one-time request-contact reply keyboard.
"""
...
async def render_message(
    ...
    Also deletes the user's just-sent message so the chat stays tidy.
    """
